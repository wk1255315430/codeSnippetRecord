            ...
            <div style={{display:this.state.editState?'block':'none'}}>
              <List
                ...
                renderItem={({ value, props }) => {
                  ...
                  // if(this.state.editState){
                  row = (
                    <div {...props} className={classnames(`${prefixCls}-container-item`)} onClick={()=>{self.gotoSubpage(value.attrName);}}>
                      <img src={value.image}/>
                      <span>{value.dev}</span>
          ...
          <div style={{display:this.state.editState?'none':'block'}}>
            {
              this.state.hotSeniorArr.map( function(item, index) {
                return (
                  <div className={classnames(`${prefixCls}-container-item`)} key={index} onClick={()=>{self.gotoSubpage(item.attrName);}}>
                    <img src={item.image}/>
                    <span>{item.dev}</span>
                    <span className={classnames(`${prefixCls}-container-item-span`)}></span>
                  </div>
