...
CREATE TABLE `article`  (
  ...
  `like` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '赞',
  `dislike` char(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '踩',
...
CREATE TABLE `article_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '博客to标签中间表' ROW_FORMAT = Compact;
...
INSERT INTO `users` VALUES (8, '790943331@qq.com', '123', 'wf', NULL, '2019-10-15 13:50:30', '2019-10-15 14:57:09', 5);
INSERT INTO `users` VALUES (9, '2444445@qq.com', '1235', 'yy', NULL, '2019-10-15 14:35:28', '2019-10-15 14:36:08', 1);
INSERT INTO `users` VALUES (10, '2444446@qq.com', '1234', 'yy', NULL, '2019-10-15 14:36:22', '2019-10-15 14:36:22', 0);
INSERT INTO `users` VALUES (11, '2444447@qq.com', '1234', 'yy', NULL, '2019-10-15 14:46:31', '2019-10-15 14:46:50', 1);
INSERT INTO `users` VALUES (12, '790943332@qq.com', '1234', 'wf', NULL, '2019-10-15 14:57:20', '2019-10-15 20:19:05', 7);
...
delimiter ;;
CREATE PROCEDURE `login`(_email VARCHAR(20),_emailCode VARCHAR(20),_nickname VARCHAR(20))
BEGIN
...
-- 	status:0密码错误,1新增用户,2再次登录用户
	...
	INSERT INTO `users`(`name`,`password`,`nickname`,`tel`,`created_at`,`updated_at`,`count`) VALUES(_email,_emailCode,_nickname,null,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),_count);
		set _status = 1;
